...
struct attribute s_Sensors_attributes[] = {
  {"farmid", "int", NULL, offsetof(struct Sensors, farmid), 0, false},
  ...
  {"IRLevel", "double", "%.02f", offsetof(struct Sensors, IRLevel), 0, false},
  {"SALevel", "double", "%.02f", offsetof(struct Sensors, SALevel), 0, false},
  {"PHLevel", "double", "%.02f", offsetof(struct Sensors, PHLevel), 0, false},
  {"DOLevel", "double", "%.02f", offsetof(struct Sensors, DOLevel), 0, false},
  {"retrycount", "int", NULL, offsetof(struct Sensors, retrycount), 0, false},
  {"lifecount", "int", NULL, offsetof(struct Sensors, lifecount), 0, false},
  {"pool", "int", NULL, offsetof(struct Sensors, pool), 0, false},
  {"unit", "int", NULL, offsetof(struct Sensors, unit), 0, false},
  {"interval", "int", NULL, offsetof(struct Sensors, interval), 0, false},
  {"retry", "int", NULL, offsetof(struct Sensors, retry), 0, false},
  {"DO", "bool", NULL, offsetof(struct Sensors, DO), 0, false},
  {"PH", "bool", NULL, offsetof(struct Sensors, PH), 0, false},
  {"Sal", "bool", NULL, offsetof(struct Sensors, Sal), 0, false},
  {"IR", "bool", NULL, offsetof(struct Sensors, IR), 0, false},
  {"batVolts", "double", NULL, offsetof(struct Sensors, batVolts), 0, false},
